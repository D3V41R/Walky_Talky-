...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, RLYR_NRST_Pin|TRANSMIT_MODE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RLYR_NRST_Pin TRANSMIT_MODE_Pin */
  GPIO_InitStruct.Pin = RLYR_NRST_Pin|TRANSMIT_MODE_Pin;
